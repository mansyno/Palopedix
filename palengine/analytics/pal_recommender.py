...
class PalRecommender:
    ...
    def calculate_pal_base_score(
        ...
        return {
            ...
            "work_suitabilities": pal.get("work_suitabilities") or pal.get("suitabilities", {}),
            "suitabilities": pal.get("suitabilities") or pal.get("work_suitabilities", {}),
            "work_suitability_details": pal.get("work_suitability_details", []),
            "partner_skill": pal.get("partner_skill"),
            "partner_skill_categories": pal.get("partner_skill_categories", []),
            "gear": pal.get("gear"),
            "ivs": pal.get("ivs", {}),
            "iv_hp": pal.get("iv_hp"),
